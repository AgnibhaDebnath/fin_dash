...
const Navbar = ({ role, setRole, activeTab, setIsSidebarOpen }) => {
    ...
    return (
        <nav className="px-4 md:px-5 py-6 flex flex-row justify-between bg-white shadow-xl fixed top-0 w-full z-50">
            ...
            <div className="relative hidden md:block">
                ...
                <input type="text" placeholder="Search..." className="border-2 rounded-full pl-8 pr-2 py-1 text-justify hidden md:block " />
            </div>

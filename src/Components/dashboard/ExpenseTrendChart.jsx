...
const ExpenseTrendChart = ({ transactions }) => {
    ...
    let expenseTrendData = [], filteredExpenseTrendData = []
        ...
        <>
            {
                ...
                filteredExpenseTrendData?.length > 0 ? <div className="w-full min-[1350px]:w-3/5 h-83 " >
                    ...
                    <ResponsiveContainer initialDimension={{ width: 600, height: 400 }} width="100%" height="100%">
                        <LineChart data={filteredExpenseTrendData} >
                            ...
                            />
                            <Legend iconSize={20} labelStyle={{ fontWeight: "20px", fontSize: "1.1rem", marginLeft: "4px" }} formatter={(value) => {
                    ...
                    <div className="w-full min-[1350px]:w-3/5 flex flex-col items-center ">
                        <h3 className="text-gray-700 font-bold text-center text-2xl">
                            Expense Trend
                        </h3>
                        <FaChartLine className="text-5xl mt-5 block text-gray-400" />
                        <h4 className="text-lg text-gray-700 font-medium tracking-wide mt-3">No expense trend data available.</h4>
                        <p className="text-sm min-[390px]:text-base text-gray-600 font-medium mt-4 tracking-wide text-center">Add expense transactions to view your spending trend.</p>
                    </div>

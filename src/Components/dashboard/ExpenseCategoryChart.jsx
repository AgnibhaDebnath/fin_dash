import { Tooltip, PieChart, Pie, Sector, ResponsiveContainer, Legend, Curve, Label } from "recharts"
...
const ExpenseCategoryChart = ({ transactions }) => {
    ...
    return (
        <>
            {expenseByCategory.length > 0 ? <div className="flex items-center flex-col h-95 w-full min-[1350px]:w-2/5 pt-8">
                <div className="">
                ...
                <ResponsiveContainer initialDimension={{ width: 600, height: 400 }} width="100%" height="100%" >
                    <PieChart>
                        <Pie
                            ...
                            labelLine={(props) => {
                                if (props.percent < 0.01) return null;
                            ...
                            shape={(props) => {
                                ...
                                return <Sector {...rest} fill={CATEGORY_COLORS[props.payload.category]} />;
                            }}
                        />
                        <Label
                            content={({ viewBox }) => {
                ...
                <div className="flex items-center flex-col mt-0 max-[1350px]:mt-10 w-full min-[1350px]:w-2/5  ">
                    ...
                    <FaChartPie className="text-5xl mt-6 text-gray-400" />
                    <p className="text-lg font-medium text-gray-700 mt-3">No expense categories yet</p>
                    <p className="text-base font-medium text-gray-500 mt-3">Add expenses to see breakdown</p>
                </div>
            }
        </>
    )

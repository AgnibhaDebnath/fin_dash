...
const IncomeExpenseChart = ({ transactions, isLoading }) => {
    ...
    return (
        <section className="mt-6 py-4 pb-10 pr-4 pl-2 sm:pl-14 shadow-lg font-[inter]">
            {isLoading ? (
                ...
                <>
                    <div className="w-full my-5 flex flex-col items-center justify-end ">
                        ...
                        <FaChartBar className="text-5xl mb-3 block text-gray-200" />
                        <h4 className="font-medium text-[1.1rem] text-gray-700 tracking-wide">
                            No income vs expense data available
                        </h4>
                        <p className="text-gray-600 mt-4 text-[0.8rem] sm:text-base tracking-wide">
                            Add transactions to view your income and expense trends.
                        </p>
                    </div>
                </>
            )}
